    ...
    public class DAL_SN_Customers
    {
        ...
        public DataSet SN_Customers_Insert(SN_CustomersInfo _SN_CustomersInfo)
        {
            try
            {
                ...
                new SqlParameter("@IPAddress", _with1.IPAddress),
                new SqlParameter("@Longitude", _with1.Longitude),
                new SqlParameter("@Latitude", _with1.Latitude),
                new SqlParameter("@LastLoginDate", _with1.LastLoginDate),
                new SqlParameter("@CustomerActive", _with1.CustomerActive)
            };
